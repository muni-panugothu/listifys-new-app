...
export type EventsHubTab = {
  id: EventsHubTabId;
  label: string;
  icon: ImageSourcePropType;
};

export const EVENTS_HUB_TABS: EventsHubTab[] = [
  {
    id: "home",
    label: "Home",
  ...
  },
  {
    id: "dining",
    label: "Dining",
    icon: require("@/assets/events/hub/hub-icon-dining.png"),
  },
  {
    id: "movies",
    label: "Movies",
    icon: require("@/assets/events/hub/hub-icon-movies.png"),
  },
  {
    id: "events",
    label: "Events",
    icon: require("@/assets/events/hub/hub-icon-events.png"),
  },
  {
    id: "stores",
    label: "Stores",
  ...
  },
  {
    id: "activities",
    label: "Activities",
    icon: require("@/assets/events/hub/hub-icon-activities.png"),
  },
  {
    id: "play",
    label: "Play",
    icon: require("@/assets/events/hub/hub-icon-play.png"),
  },
];
